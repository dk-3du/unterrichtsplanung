...
PAARE = [
    ...
    ("Beschreibung und Kommentar", "Modell/Planungsdatei.swift", "maxTextlaenge",
     "MAX_TEXTLAENGE", 1),
    ("Titel, Namen", "Modell/Planungsdatei.swift", "maxNamenslaenge",
     "MAX_NAMENSLAENGE", 1),
    ("Kennungen", "Modell/Planungsdatei.swift", "maxKennungslaenge",
     "MAX_KENNUNGSLAENGE", 1),
    ...
    ("Freie Tage", "Modell/Planungsdatei.swift", "maxFreieTage",
     "MAX_FREIE_TAGE", 1),
    ("Planungsdatei, Groesse", "Modell/Planungsdatei.swift", "hoechstgroesse",
     "MAX_DATEIGROESSE", 1),
    ...
    ("Tresor, Wicklungen je Behaelter", "Dienste/Tresor.swift", "wicklungenHoechstens",
     "TRESOR_WICKLUNGEN_HOECHSTENS", 1),
    ("Tresor, Wicklung Tiefe", "Dienste/Tresor.swift", "wicklungTiefeHoechstens",
     "TRESOR_WICKLUNG_TIEFE_HOECHSTENS", 1),
    ("Tresor, Wicklung Eintraege", "Dienste/Tresor.swift", "wicklungEintraegeHoechstens",
     "TRESOR_WICKLUNG_EINTRAEGE_HOECHSTENS", 1),
    ("Tresor, Wicklung Text", "Dienste/Tresor.swift", "wicklungTextHoechstens",
     "TRESOR_WICKLUNG_TEXT_HOECHSTENS", 1),
]
