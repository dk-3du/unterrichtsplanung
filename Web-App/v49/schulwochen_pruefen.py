...
"""
    ...
    try:
        try:
            # Mit Frist: Ein haengender jsc haelt die Pruefung nicht ewig (B15).
            lauf = subprocess.run([str(JSC), str(ablage)], capture_output=True, text=True, timeout=120)
        except subprocess.TimeoutExpired:
            raise SystemExit("jsc antwortete nicht binnen 120 s — Pruefung abgebrochen")
