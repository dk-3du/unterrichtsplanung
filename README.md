...
Die macOS-App (`macOS-App/v53/`) ist in Swift und SwiftUI geschrieben, für
...
([`Web-App/v53/LICENSE.txt`](Web-App/v53/LICENSE.txt)). Die Zuordnung je Datei
steht in [`REUSE.toml`](REUSE.toml), die Lizenztexte liegen in
[`LICENSES/`](LICENSES/). © 2026 Dominik Kluge. Erstellt mit Claude Code
(Opus 5 & Fable 5/5.1).

**Aufbau.** Je Fassung ein eigener, für sich baubarer Ordner (`macOS-App/v53/`,
`Web-App/v53/`; ältere Fassungen bleiben daneben stehen); die Nummer im
