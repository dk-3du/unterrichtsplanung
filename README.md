...
Die macOS-App (`macOS-App/v57/`) ist in Swift und SwiftUI geschrieben, für
...
([`Web-App/v57/LICENSE.txt`](Web-App/v57/LICENSE.txt)). Die Zuordnung je Datei
steht in [`REUSE.toml`](REUSE.toml), die Lizenztexte liegen in
[`LICENSES/`](LICENSES/). © 2026 Dominik Kluge. Erstellt mit Claude Code
(Opus 5 & Fable 5/5.1).

**Aufbau.** Je Fassung ein eigener, für sich baubarer Ordner (`macOS-App/v57/`,
`Web-App/v57/`; ältere Fassungen bleiben daneben stehen); die Nummer im
