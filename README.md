...
- **macOS-App** (`macOS-App/v43/`): Swift und SwiftUI, macOS 26 auf Apple
  ...
  — zu finden unter **Releases** dieses Repositorys.
...
- **Ansicht fürs iPad** (`Web-App/v43/`): eine einzige HTML-Datei, im Netz
  ...
  schützt vor eingeschleustem Code, nicht vor einem ersetzten Server; darum
  liegt jede Fassung der Ansicht seit 1.4.2 auch als Datei beim Release, mit
  SHA-256-Prüfsumme: `curl -s https://3ducation.org/upapp/index.html | shasum
  -a 256` muss die Zeile im Release ergeben.
...
**English.** *Unterrichtsplanung* is a year-at-a-glance
...
pointed it once; with encryption on, those bookmarks are sealed next to the
plan as well. An optional, weekly
