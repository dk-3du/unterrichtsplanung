...
- **macOS-App** (`macOS-App/v33/`): Swift und SwiftUI, macOS 26 auf Apple
...
- **Ansicht fürs iPad** (`Web-App/v33/`): eine einzige HTML-Datei, im Netz
...
([`Web-App/v33/LICENSE.txt`](Web-App/v33/LICENSE.txt)). Die Zuordnung je Datei
steht in [`REUSE.toml`](REUSE.toml), die Lizenztexte liegen in
[`LICENSES/`](LICENSES/). © 2026 Dominik Kluge. Erstellt mit Claude Code
(Opus 5 & Fable 5/5.1).

**Aufbau.** Je Fassung ein eigener, für sich baubarer Ordner (`macOS-App/v33/`,
`Web-App/v33/`); die Nummer im Ordnernamen ist der Build der Version. Was sich
je Fassung ändert, steht in [`CHANGELOG.md`](CHANGELOG.md). Oberfläche und
...
passphrase, with a printed recovery key for emergencies. The user interface
