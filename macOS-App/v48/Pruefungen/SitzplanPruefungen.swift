...
struct SitzplanPruefungen {
    ...
    func dateiMuell() throws {
        ...
        let roh: [String: Any] = ["typ": "unterrichtsplanung-sitzplaene", "version": 1, "plaene": [
            "k-eins": ["tische": tische, "lehrertisch": ["x": -100, "y": 9999], "geaendert": "2026-09-12T10:00:00"],
            "": ["tische": []],
            "/böse": ["tische": []],
        ...
        #expect(p.geaendert == "2026-09-12T10:00:00")
    ...
    func druck() throws {
        ...
        p.geaendert = "2026-09-12T10:15:00"
        #expect(Sitzplandruck.kopfzeile(klasse, plan: p) == "7a · Mathematik · Sitzplan · Stand 12.09.2026")
        klasse.fach = ""
        #expect(Sitzplandruck.kopfzeile(klasse, plan: p) == "7a · Sitzplan · Stand 12.09.2026")
        p.geaendert = ""
