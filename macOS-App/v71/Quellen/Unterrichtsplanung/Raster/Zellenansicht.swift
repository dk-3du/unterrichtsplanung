...
final class Zellenkoerper: NSView {
    ...
    private func zeichnen() {
        ...
        // Die erste Sonderzeile trägt oben die kräftigere Linie (E158) —
        // gespiegelte Ansicht: y 0 ist die Oberkante.
        if daten.zeilen[zeile].sonderzeilenBeginn {
            Rasterfarben.sonderzeilenlinie.setFill()
