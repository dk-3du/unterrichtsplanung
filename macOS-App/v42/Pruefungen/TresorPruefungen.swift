...
struct AblageVersiegeltPruefungen {
    ...
    func altbestaende() throws {
        ...
        let t = try tresor()
        let erster = ablage.altbestaendeVersiegeln(mit: t)
        ...
        #expect(ablage.altbestaendeVersiegeln(mit: t).umgestellt.count == 3)

        let zurueck = ablage.altbestaendeEntsiegeln(t)
    ...
    func schluesselwechsel() throws {
        ...
        #expect(ablage.altbestaendeVersiegeln(mit: neuer, alter: alter).umgestellt == ["planung-vorher.json"])
        ...
        let ohneAlten = ablage.altbestaendeVersiegeln(mit: neuer, alter: nil)
