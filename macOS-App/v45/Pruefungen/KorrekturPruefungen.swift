...
struct FachfarbenPruefungen {
    ...
    @Test("Eine Planung der alten Palette — ohne Fassung — wird benannt abgewiesen, nicht umgedeutet")
    func altePaletteAbgewiesen() throws {
        // Ohne „version“: alte Plätze. Die App liest sie nicht mehr — mit
        // Platz 0 als Rot statt Biologie öffnete die Datei sonst falsch.
        let alt = #"""
        ...
        """#
        do {
            _ = try Planungsdatei.lesen(Data(alt.utf8))
            Issue.record("eine Datei der alten Palette darf nicht gelesen werden")
        } catch let fehler as Planungsfehler {
            #expect(fehler.text.contains("nicht mehr unterstützten Fassung"))
        }
    ...
    func handfarbeOhneFarbe() throws {
        let alt = #"""
        {"typ":"unterrichtsplanung","version":2,"titel":"Alt","start":"2026-08-03","wochen":4,
...
struct PruefungsPruefungen {
    ...
    func alteDatei() throws {
        ...
        let roh = """
        {"typ":"unterrichtsplanung","version":2,"titel":"Alt","start":"2026-08-03",
...
struct DatumUndDringlichkeit {
    ...
    func unlesbaresDatum() throws {
        let roh = """
        {"typ":"unterrichtsplanung","version":2,"titel":"X","start":"2026-08-03","wochen":4,
...
struct SperrzeitPruefungen {
    ...
    func vertauscht() throws {
        let roh = """
        {"typ":"unterrichtsplanung","version":2,"start":"2026-08-03","wochen":4,
