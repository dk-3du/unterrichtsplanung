...
final class Ordnerzugriff {
    ...
    /// denselben Weg wie das Öffnen zurücklesen und vergleichen. `nil` heißt
    /// gelungen, sonst der Grund.
    private func behaelterSchreiben() -> String? {
        ...
        do {
            ...
            guard gedeutet.eintraege == eintraege, gedeutet.zielordner == gemerkterZielordner else {
                return "die Nutzlast liest sich anders, als sie geschrieben wurde"
            }
            ...
            guard behaelter.count <= Ordnerzugriff.hoechstgroesse else {
                return "der Behälter wäre mit \(behaelter.count / 1024 / 1024) MB größer als die Lesegrenze"
            }
