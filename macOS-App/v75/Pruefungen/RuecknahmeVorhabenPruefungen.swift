...
struct RuecknahmeVorhabenPruefungen {
    ...
    static let faelle: [Fall] = [
        ...
        Fall(name: Schrittname.alsKorrekturKennzeichnen) { s, id in s.korrekturUmschalten(id) },
        Fall(name: Schrittname.korrekturEntfernen,
             vorbereiten: { s, id in s.korrekturUmschalten(id) }) { s, id in
            s.korrekturUmschalten(id)
        },
