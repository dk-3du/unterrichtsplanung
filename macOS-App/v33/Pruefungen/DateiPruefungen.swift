...
struct SicherungskopiePruefungen {
    ...
    // Zwei Fragen: erst die Verschlüsselung, dann die Kopie.

    @Test("Verschlüsselung zuerst: Einrichten, Abbrechen, Weiter, Einschalten — dann die Kopie")
    func ersteinrichtungInSchritten() throws {
        ...
        // Eine versiegelte Planung als erste: nur noch die zweite Frage.
        speicher.offenerDialog = nil
        speicher.ersteinrichtungOeffnen()
        #expect(speicher.ersteinrichtungsschritt == Schritt.sicherung)
    }

    @Test("Überspringen lässt die Verschlüsselung aus und führt zur Kopie")
