        ...
        biometrie
            ? Starthinweis(
                ...
                rest: "Die Passphrase ist auf diesem Mac nur fällig, wenn der Schalter „Mit Touch ID "
                    + "öffnen“ ausgeschaltet wird; in der Web App und auf jedem anderen Rechner öffnet "
            ...
            : Starthinweis(
                ...
                rest: "Die Passphrase ist auf diesem Mac nur fällig, wenn der Schalter „Mit dem "
                    + "Anmeldepasswort öffnen“ ausgeschaltet wird; in der Web App und auf jedem anderen "
        ...
        var starthinweis: Starthinweis? {
            ...
            case .nichtVerfuegbar:
                Starthinweis(
                    ...
                    rest: "So öffnet die Planung auch in der Web App und auf jedem anderen Rechner.")
            case .gescheitert:
                nil
            }
        }
        ...
        var meldung: (text: String, warnung: Bool)? {
            ...
            case .angelegt(biometrie: false):
                ("Beim Start öffnet das Anmeldepasswort dieses Macs die Planung — dasselbe "
                 + "Passwort wie bei der Anmeldung am Mac; die Passphrase gilt in der Web App und "
                 + "auf jedem anderen Rechner.", false)
            case .nichtVerfuegbar:
                ("Dieser Mac bietet keine Wicklung für das Gerät (keine Secure Enclave verfügbar) — "
                 + "beim Start ist die Passphrase fällig, wie in der Web App und auf jedem anderen Rechner.", false)
