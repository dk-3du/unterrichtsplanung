...
final class Planungsspeicher {
    ...
    func widerrufen() {
        ...
        guard let naechster = verlauf.zurueck.last, beiwerkGeht(naechster) else { return }
    ...
    func wiederholen() {
        ...
        guard let naechster = verlauf.vor.last, beiwerkGeht(naechster) else { return }
    ...
    private func beiwerkGeht(_ schritt: Ruecknahme<Planung>.Schritt) -> Bool {
        guard let grund = schritt.beiwerk?.moeglich() else { return true }
