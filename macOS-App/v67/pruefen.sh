...
bauversionSchritt
# Der Rundentreiber gehört zum Quellenstand (E146, v67): Seine Form wird hier
# mitgeprüft; die Runde selbst fährt er am gebauten Paket (./runde.py).
schritt "runde.py --syntax (Form des Rundentreibers)" python3 "$HIER/runde.py" --syntax
cd "$ANSICHT"
