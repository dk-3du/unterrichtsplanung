...
/// Die drei Fragen beim ersten Start, alle freiwillig. Zuerst:
...
/// Zuletzt: Soll die App beim Öffnen nach Updates suchen? Gefragt wird genau
/// einmal; „Überspringen“, „Später“ und „Nicht jetzt“ zählen als Antwort.
///
...
struct ErsteinrichtungDialog: View {
    ...
    /// Wie viele Fragen das Blatt stellt: drei — oder zwei, wenn es ohne die
    /// Verschlüsselungsfrage begann, weil die Planung schon versiegelt war.
    @State private var fragen = 3
    ...
    private var inDerEinrichtung: Bool {
        ...
        case .sicherung, .updates: false
        }
    }

    var body: some View {
        // Die dritte Frage ist kurz — ihr Blatt auch.
        Dialograhmen(titel: titel, unterzeile: unterzeile, breite: 640,
                     hoehe: speicher.ersteinrichtungsschritt == .updates ? 560 : 680,
        ...
        .onAppear { fragen = speicher.ersteinrichtungsschritt == .sicherung ? 2 : 3 }
    }
    ...
    private var unterzeile: String {
        ...
        case .sicherung: "Ersteinrichtung, Frage \(fragen - 1) von \(fragen) — " + freiwillig
        case .updates: "Ersteinrichtung, Frage \(fragen) von \(fragen) — " + freiwillig
        }
    }
    ...
    /// Frage, auf der zweiten „Später“, auf der dritten „Nicht jetzt“ — nie
    ...
    /// Die dritte Antwort schließt das Blatt.
