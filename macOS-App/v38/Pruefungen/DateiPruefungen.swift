...
struct StatusPruefungen {
    ...
    @Test("Die Fassung wird geprüft — fehlend gilt, 1 gilt, alles andere nicht")
    func fassung() throws {
        ...
        #expect(try Statusdatei.lesen(datei("{\"eintraege\":{\"e-1\":{\"erledigt\":true}}}"))
                    .eintraege.count == 1, "ohne Fassung: der Altbestand")
