...
enum Statusdatei {
    ...
    static func lesen(_ daten: Data) throws -> Statusstand {
        ...
        // dieselben Felder anders meinen. Fehlt sie, ist es eine Datei aus der
        // Zeit vor dem Feld — die wird wie bisher gelesen. Dieselbe Regel gilt in
        // der Ansicht (`statusstandLesen`): nur die Zahl 1, keine Zeichenkette,
        // kein Wahrheitswert, kein Bruch.
        if let rohVersion = d["version"] {
