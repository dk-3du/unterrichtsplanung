            ...
            Section {
                ...
                if speicher.enklaveMoeglich {
                    Button {
                        ...
                        Label("\(Tresor.freigabeNameGross) erneut versuchen",
...
struct VerschluesselungDialog: View {
    ...
    private var uebersicht: some View {
        ...
        if Tresor.enklaveVerfuegbar {
            Section {
                Toggle(Tresor.schalterName, isOn: Binding(
                ...
                Text("An: Beim Start öffnet \(Tresor.freigabeName) die Planung. "
                     + "Aus: Beim Start ist die Passphrase fällig. "
                     + (Tresor.biometrieEingerichtet ? ""
                        : "Wird Touch ID später eingerichtet, stellt Aus und wieder An die "
                          + "Wicklung darauf um. ")
                     + "Die Kopie beim Beenden und der Export bleiben davon unberührt.")
            }
        }
