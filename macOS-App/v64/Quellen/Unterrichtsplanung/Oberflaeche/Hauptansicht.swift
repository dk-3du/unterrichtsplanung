    ...
    private var gesperrt: some View {
        ContentUnavailableView {
            ...
            Text(speicher.entsperrungLaeuft
                 ? "Die Freigabe über \(Tresor.freigabeName) steht noch aus."
                 : "Die Planung auf diesem Mac ist verschlüsselt. Zum Öffnen braucht es "
                   + "\(Tresor.freigabeName), die Passphrase oder den "
            ...
            HStack(spacing: 12) {
                Button {
                    ...
                    Label(speicher.enklaveMoeglich
                          ? (Tresor.biometrieEingerichtet ? "Mit Touch ID" : "Mit Anmeldepasswort")
                          : "Entsperren …",
