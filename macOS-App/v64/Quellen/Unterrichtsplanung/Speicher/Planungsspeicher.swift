...
final class Planungsspeicher {
    ...
    /// Warum die Wicklung dieses Macs bei der Vorbereitung nicht zustande kam
    /// (B32, E131) — Schritt 2 des Blatts zeigt ihn, das Einschalten meldet ihn.
    var vorbereitungHinweis: String?
