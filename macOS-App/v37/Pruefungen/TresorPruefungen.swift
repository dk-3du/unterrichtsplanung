...
struct AblageVersiegeltPruefungen {
    ...
    func altbestaende() throws {
        ...
        let t = try tresor()
        ablage.tresor = t
        let erster = ablage.altbestaendeVersiegeln()
        ...
        #expect(ablage.altbestaendeVersiegeln().umgestellt.count == 3)
    ...
    func schluesselwechsel() throws {
        ...
        ablage.tresor = neuer
        #expect(ablage.altbestaendeVersiegeln(alter: alter).umgestellt == ["planung-vorher.json"])
        ...
        ablage.tresor = neuer
        let ohneAlten = ablage.altbestaendeVersiegeln(alter: nil)
