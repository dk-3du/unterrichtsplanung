...
final class Planungsspeicher {
    ...
    /// Was der Übergabestand beim Start vorfindet (E50): Eine Marke mit
    /// passenden Zwillingen wird eingesetzt; Zwillinge ohne Marke werden
    /// entfernt; was nicht zu vollenden ist, kommt gestempelt ins Register,
    /// und der bisherige Stand gilt. Nur wenn nichts einzusetzen und nichts
    /// beiseitezulegen war (der Ordner lässt sich nicht schreiben), wird
    /// nichts geladen — `false`.
