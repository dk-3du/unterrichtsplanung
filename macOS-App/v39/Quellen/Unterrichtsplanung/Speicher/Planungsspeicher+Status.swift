...
extension Planungsspeicher {
    ...
    func statusUebernehmen() {
        ...
        do {
            ...
            // Beim Lesen kommt nur die Größe als Hindernis; alles andere bleibt
            // beim Schreiben der Kopie oder beim Übergang des Schutzes.
            if case .zuGross(let groesse) = error {
