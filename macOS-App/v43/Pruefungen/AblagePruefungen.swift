...
struct SicherungswegPruefungen {
    ...
    func ueberDerDecke() throws {
        ...
        try Data(count: Planungsdatei.hoechstgroesseEigene + 1).write(to: Ablage.shared.datei)
    ...
    func schreibgrenze() throws {
        ...
        #expect(daten.count > Planungsdatei.hoechstgroesse && daten.count < Planungsdatei.hoechstgroesseEigene)
        ...
        #expect(warnungen.count == 1 && warnungen[0].text.contains("größer als die Lesegrenze"), "\(warnungen)")
        ...
        #expect(speicher.sicherung.ablagegroesse.map { $0 < Planungsdatei.hoechstgroesse } == true)
    }
