...
final class Rasterdaten {
    ...
    struct Kachelstand: Equatable {
        ...
        var istKorrektur: Bool { vorhaben.korrektur }
        var istHausaufgabe: Bool { vorhaben.hausaufgabe }
        ...
        /// Die Zeile „Korrektur“ an derselben Stelle — `nil`, wenn keine Korrektur.
        let gesetzteKorrektur: NSAttributedString?
    ...
    struct Zeilenstand {
        ...
        /// Die erste Sonderzeile — über ihr zieht das Raster die kräftigere
        /// Trennlinie (E158): in der Kursspalte und in jeder Zelle der Reihe.
        let sonderzeilenBeginn: Bool
    }
    ...
    init(_ planung: Planung, stand: Int, breite: CGFloat, vorher: Rasterdaten? = nil) {
        ...
        for (stelle, klasse) in planung.klassen.enumerated() {
            ...
            for (woche, eintraege) in eigene {
                ...
                for (i, vorhaben) in eintraege.enumerated() {
                    ...
                    if let alt = altbestand[vorhaben.id], alt.vorhaben == vorhaben {
                        stand.append(alt.kannHoch == (i > 0)
                                     ...
                                     : Kachelstand(vorhaben: alt.vorhaben, hoehe: alt.hoehe,
                                                   ...
                                                   gesetzteKorrektur: alt.gesetzteKorrektur,
                    ...
                    let titelhoehe = max(Zellenmass.hoeheHaken, Zellenmass.hoeheVonText(
                        ...
                        breite: Zellenmass.titelbreite(innen: innen, hausaufgabe: vorhaben.hausaufgabe),
                    ...
                    stand.append(Kachelstand(
                        ...
                        gesetztePruefung: vorhaben.pruefung ? Textsatz.setzen(
                            ...
                            umbricht: false) : nil,
                        gesetzteKorrektur: vorhaben.korrektur ? Textsatz.setzen(
                            Korrekturmarke.wort, stil: .caption2, gewicht: .semibold,
                            farbe: Rasterfarben.pruefung, durchgestrichen: false,
                            umbricht: false) : nil,
            ...
            zeilen.append(Zeilenstand(
                ...
                sonderzeilenBeginn: klasse.istSonderzeile
                    && !(planung.klassen[safe: stelle - 1]?.istSonderzeile ?? false)))
            oben += hoechste
        }
