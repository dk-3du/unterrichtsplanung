...
extension Planungsspeicher {
    ...
    func neuePlanung(titel: String, start: Tag, wochen: Int, basis: String,
        ...
        let sauberer = Planungsdatei.zugeschnitten(titel, grenze: Planungsdatei.maxNamenslaenge,
                                                   leerraum: .whitespaces).text
        let gekappt = sauberer.isEmpty ? "Unterrichtsplanung" : sauberer
