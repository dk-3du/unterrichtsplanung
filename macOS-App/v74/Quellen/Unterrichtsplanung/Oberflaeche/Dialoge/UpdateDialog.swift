                ...
                if !notizen.isEmpty {
                    Section {
                        notizentext(notizen)
                            ...
                            .fixedSize(horizontal: false, vertical: true)
                            // Verweise aus dem Release gehen nur als http/https
                            // hinaus — dieselbe Schranke wie beim Download-Knopf.
                            .environment(\.openURL, OpenURLAction { adresse in
                                Systemzugriff.adresseOeffnen(adresse.absoluteString)
                                return .handled
                            })
                    } header: {
