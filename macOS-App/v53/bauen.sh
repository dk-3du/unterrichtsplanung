...
Verschlüsselung
  ...
  Stand: Ein Neustart vollendet oder verwirft, was ein Abbruch offen ließ,
  oder nimmt zurück, was sich nicht vollenden lässt; bis ein Übergang
  eingesetzt ist, ruht jede Änderung an der Ablage. Lässt sich nicht mehr
  feststellen, welche Dateien zu einem unterbrochenen Übergang gehören, rührt
  die App nichts an und sagt, was zu prüfen ist.
