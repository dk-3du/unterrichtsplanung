...
final class Planungsspeicher {
    ...
    ///
    /// Zurückgelegt wird der Inhalt, nicht die Autorität (N58-01, E109): Was
    /// die Rücknahme an Haken oder Kommentar ändert, trägt danach einen
    /// frischen Statusstempel — sonst gewänne ein liegengebliebener iPad-Stand
    /// gegen das Widerrufen (`Statusabgleich.nachRuecknahme`).
