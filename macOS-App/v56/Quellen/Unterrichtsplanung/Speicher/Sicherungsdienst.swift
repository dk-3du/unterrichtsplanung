...
final class Sicherungsfolge: @unchecked Sendable {
    ...
    private enum Zustand {
        ...
        /// zuerst nach (E54).
        case einsetzenOffen(marke: Uebergangsmarke, ordner: URL, stand: String)
    ...
    func uebergeben(nummer: Int, stand: String, marke: Uebergangsmarke, ordner: URL,
        ...
        sperre.withLock {
            ...
            if befund == .vollendet {
                ...
                letzterStand = nil
                zustand = .einsetzenOffen(marke: marke, ordner: ordner, stand: stand)
            }
            return befund
        }
    }
    ...
    private func nachholenGesperrt() -> String? {
        ...
        case .ungeprueft:
            ...
            zustand = .bereit
            return nil
        case .einsetzenOffen(let marke, let ordner, let stand):
    ...
    func schreiben(nummer: Int, stand: String, daten: Data, tresor: Tresor?) throws -> Ergebnis {
        try sperre.withLock {
            ...
            do { groesse = try ablage.schreiben(daten, tresor: tresor, hoechstens: grenze) }
                ...
                return sperre.anlass == .ungewiss ? .formUnklar(sperre.grund) : .form(sperre.grund)
            }
            letzterStand = stand
...
final class Sicherungsdienst {
    ...
    var schreibsperrgrund: String? {
        ...
        switch stoerung {
        case .zuGross, .uebergangOffen, .form, .formUnklar: return stoerung?.kurz
