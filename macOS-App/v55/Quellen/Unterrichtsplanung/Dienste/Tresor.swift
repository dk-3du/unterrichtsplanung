...
final class Tresor: @unchecked Sendable {
    ...
    /// Für den Formwächter (E72), der nur den Kopf liest: Kündigen die ersten
    /// Byte einen Behälter an? Das deutet keine Datei — es beantwortet allein
    /// die Frage, ob an dieser Stelle Schutz liegt. Was der Vorsatz nicht
    /// zeigt, gilt dort als Klartext.
