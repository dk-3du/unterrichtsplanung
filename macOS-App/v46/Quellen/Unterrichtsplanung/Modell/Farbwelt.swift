...
enum Farbwelt {
    ...
    /// Nach NFC, damit die Ansicht — die Schlüssel Codepunkt für Codepunkt
    /// vergleicht — dasselbe Fach findet wie Swift mit seiner kanonischen
    /// Gleichheit (é gegen e + U+0301).
